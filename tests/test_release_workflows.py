...
def test_jarvis_release_requirement_enforces_unified_gray_scott_contract() -> None:
    ...
    assert lock_binding["expected_version"] == "1.8.0"
    ...
    assert clio_kit_component["distribution_version"] == "2.6.6"
    ...
    assert native_execution["contract_id"] == "clio-kit-jarvis-user-v3.7"
    assert native_execution["contract_sha256"] == (
        "d34761523f39e75b144a0567eb368c3cb51c199ea40da0010aaf572afdd2cec4"
    )
    ...
    assert jarvis_component["install_spec"].endswith("/v1.8.0/jarvis_cd-1.8.0-py3-none-any.whl")
    ...
    assert lammps_worker["metadata_equals"]["components"] == {"jarvis-cd": "1.8.0"}
    assert (
