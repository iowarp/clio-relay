...
from clio_relay.bootstrap import render_ares_bootstrap_script


def test_ares_bootstrap_script_installs_required_components() -> None:
    script = render_ares_bootstrap_script(frp_version="0.69.1")
