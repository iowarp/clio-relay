...
WHEEL_FILENAME = "clio_kit-2.5.20-py3-none-any.whl"
WHEEL_SHA256 = "15cca215635c60ee92cfccda23991ec95799488fa617e17b1960629faeb4e05e"
WHEEL_URL = f"https://github.com/iowarp/clio-kit/releases/download/v2.5.20/{WHEEL_FILENAME}"
...
def test_runtime_and_ci_share_one_exact_clio_kit_release_pin() -> None:
    ...
    assert CLIO_KIT_JARVIS_MCP_VERSION == "2.5.20"
    assert CLIO_KIT_SPACK_USER_WHEEL_VERSION == "2.5.20"
    assert CLIO_KIT_SCIENTIFIC_CATALOG_USER_WHEEL_VERSION == "2.5.20"
...
def test_ci_wheel_download_is_bounded_https_only_and_fail_closed() -> None:
    ...
    for script in scripts.values():
        ...
        assert "clio-kit-v2.5.20" in script
