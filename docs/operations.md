...
The pinned clio-kit 2.4.7 production path removes that ambiguity upstream and
...
uv tool install --python 3.12 --no-config \
  https://github.com/iowarp/clio-kit/releases/download/v2.4.7/clio_kit-2.4.7-py3-none-any.whl
